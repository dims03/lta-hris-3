...
class User extends Authenticatable
{
    ...
    public function getImagePicAttribute()
    {
        ...
        if (empty($img)) {
            return '<img src="' . Storage::url('upload/employee/profile.png') . '" class="img-fluid" width="200px">';
        } else {
            return '<img src="' . Storage::url('upload/employee/' . $nik . '/' . $img).'" class="img-fluid" width="200px">';
        }
    }
