...
class AppraisalScore extends Model
{
    ...
    protected $fillable = ['kd','users_id','date_start','date_end','lokasi_id','atasan_id','manager_id','department_id','divisi_id','jabatan_id','department_jabatan_id','review_atasan','review_manager'];
