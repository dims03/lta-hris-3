...
<div class="form-group row">
  ...
  <div class="col-md-6">
    {!! Form::select('distrik_id',$distrik,NULL,['class'=>'form-control select2','placeholder'=>'-- Distrik --']) !!}
  </div>
</div>
<div class="form-group row">
  ...
  <div class="col-md-6">
    @if ($role==1)
      {!! Form::select('lokasi_id',$lokasi,NULL,['class'=>'form-control select2','placeholder'=>'-- Lokasi Kerja --']) !!}
    @else
...
<div class="form-group row">
  ...
  <div class="col-md-6">{!! Form::select('marriage_id',$marriage,NULL,['class'=>'form-control select2','placeholder'=>'-- Status Pernikahan --']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Golongan Darah</label></div>
  <div class="col-md-5">{!! Form::select('blood_id',$blood,NULL,['class'=>'form-control select2','placeholder'=>'-- Golongan Darah --']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Kewarganegaraan</label></div>
  <div class="col-md-7">{!! Form::select('country_id',$country,NULL,['class'=>'form-control select2','placeholder'=>'-- Kewarganegaraan --']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Suku Bangsa</label></div>
  <div class="col-md-6">{!! Form::text('suku',null,['class'=>'form-control']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Jenis PTKP</label></div>
  <div class="col-md-6">{!! Form::select('ptkp_id',$ptkp,null,['class'=>'form-control select2','placeholder'=>'-- Jenis PTKP --']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Bank</label></div>
  <div class="col-md-6">{!! Form::select('bank_id',$bank,null,['class'=>'form-control select2','placeholder'=>'-- Bank --']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Nomor Rekening</label></div>
  <div class="col-md-6">{!! Form::text('no_rek',null,['class'=>'form-control']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">BPJSTK</label></div>
  <div class="col-md-4">{!! Form::text('bpjstk',null,['class'=>'form-control']) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">BPJS Kesehatan</label></div>
  <div class="col-md-4">{!! Form::text('bpjs',null,['class'=>'form-control']) !!}</div>
</div>
<div class="form-group row">
...
<div class="form-group row">
  ...
  <div class="col-md-8">{!! Form::textarea('alamat',null,['class'=>'form-control','rows'=>2]) !!}</div>
</div>
<div class="form-group row">
  <div class="col-md-4"><label class="col-form-label">Ibu Kandung</label></div>
  <div class="col-md-8">{!! Form::text('ibu_kandung',null,['class'=>'form-control']) !!}</div>
</div>
